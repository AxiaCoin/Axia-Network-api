...
import type { ChainProperties, ContractConstructorSpec, ContractEventSpec, ContractMessageParamSpec, ContractMessageSpec, ContractProject } from '@axia-js/types/interfaces';
import type { AnyJson, Codec } from '@axia-js/types/types';
