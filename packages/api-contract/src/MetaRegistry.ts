...
import type { ChainProperties, ContractDisplayName, Si0Field, Si0LookupTypeId, Si0Type, Si0TypeDefArray, Si0TypeDefSequence, Si0TypeDefTuple, Si0TypeDefVariant, Si0Variant } from '@axia-js/types/interfaces';
import type { InterfaceTypes, TypeDef } from '@axia-js/types/types';
