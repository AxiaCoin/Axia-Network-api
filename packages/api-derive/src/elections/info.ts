...
import type { u32, Vec } from '@axia-js/types';
import type { AccountId, Balance, BlockNumber, SeatHolder } from '@axia-js/types/interfaces';
...
// SeatHolder is current tuple is 2.x-era Axlib
