...
import * as allychains from './allychains';
...
export const derive = { accounts, balances, bounties, chain, contracts, council, crowdloan, democracy, elections, imOnline, membership, allychains, session, society, staking, technicalCommittee, treasury, tx };
...
const checks: Record<string, Avail> = {
  ...
  allychains: { instances: ['allychains', 'registrar'] },
