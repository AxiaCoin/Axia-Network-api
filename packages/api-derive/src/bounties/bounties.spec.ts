...
import type { ApiInterfaceRx, SubmittableExtrinsic } from '@axia-js/api/types';
import type { Bytes, Option, StorageKey } from '@axia-js/types';
import type { Bounty, BountyIndex, ProposalIndex } from '@axia-js/types/interfaces';
import type { Codec, InterfaceTypes } from '@axia-js/types/types';

import { firstValueFrom, of } from 'rxjs';

import { ApiPromise } from '@axia-js/api';
import { DeriveCollectiveProposal } from '@axia-js/api-derive/types';
import { Proposal } from '@axia-js/types/interfaces';
...
describe('bounties derive', () => {
    ...
    defaultMockApi = {
      ...
      query: {
        ...
        treasury: {
          ...
          bountyDescriptions: {
            multi: () => of([
              optionOf(bytes('make axia even better')),
  ...
  it('combines bounties with descriptions', async () => {
    ...
    expect(result[0].description).toEqual('make axia even better');
