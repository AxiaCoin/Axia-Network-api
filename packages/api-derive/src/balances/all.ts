...
import type { ApiInterfaceRx, QueryableStorageMultiArg } from '@axia-js/api/types';
import type { Option, Vec } from '@axia-js/types';
import type { AccountId, AccountIndex, Address, Balance, BalanceLock, BalanceLockTo212, BlockNumber, VestingInfo, VestingSchedule } from '@axia-js/types/interfaces';
...
function calcLocked (api: ApiInterfaceRx, bestNumber: BlockNumber, locks: (BalanceLock | BalanceLockTo212)[]): AllLocked {
  ...
  if (Array.isArray(locks)) {
    ...
    // get the maximum of the locks according to https://github.com/axia-tech/axlib/blob/master/srml/balances/src/lib.rs#L699
