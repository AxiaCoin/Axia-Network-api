...
import type { Enum, Struct } from '@axia-js/types';
import type { Option } from '@axia-js/types/codec';
import type { AccountId, AccountIndex, AccountInfo, Address, Balance, BlockNumber, Index } from '@axia-js/types/interfaces';

import { jest } from '@jest/globals';
import { combineLatest, map, of, switchMap } from 'rxjs';

import { ApiPromise, WsProvider } from '@axia-js/api';
import { memo } from '@axia-js/rpc-core';
      ...
      types: [
        {
          ...
          types: {
            ...
            BlockNumber: 'u64',
            Currency: {
              _enum: ['Unknown', 'Usd', 'EQ', 'Eth', 'Btc', 'Eos', 'Axc']
            },
            DataPoint: {
