...
import type { DispatchError, DispatchInfo, EventRecord, ExtrinsicStatus } from '@axia-js/types/interfaces';
import type { AnyJson, ISubmittableResult } from '@axia-js/types/types';
