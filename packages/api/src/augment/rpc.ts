...
import type { Bytes, HashMap, Json, Metadata, Null, Option, StorageKey, Text, U256, U64, Vec, bool, u32, u64 } from '@axia-js/types';
import type { ExtrinsicOrHash, ExtrinsicStatus } from '@axia-js/types/interfaces/author';
import type { EpochAuthorship } from '@axia-js/types/interfaces/babe';
import type { BeefySignedCommitment } from '@axia-js/types/interfaces/beefy';
import type { BlockHash } from '@axia-js/types/interfaces/chain';
import type { PrefixedStorageKey } from '@axia-js/types/interfaces/childstate';
import type { AuthorityId } from '@axia-js/types/interfaces/consensus';
import type { ContractCallRequest, ContractExecResult, ContractInstantiateResult, InstantiateRequest } from '@axia-js/types/interfaces/contracts';
import type { CreatedBlock } from '@axia-js/types/interfaces/engine';
import type { EthAccount, EthCallRequest, EthFilter, EthFilterChanges, EthLog, EthReceipt, EthRichBlock, EthSubKind, EthSubParams, EthSyncStatus, EthTransaction, EthTransactionRequest, EthWork } from '@axia-js/types/interfaces/eth';
import type { Extrinsic } from '@axia-js/types/interfaces/extrinsics';
import type { EncodedFinalityProofs, JustificationNotification, ReportedRoundStates } from '@axia-js/types/interfaces/grandpa';
import type { MmrLeafProof } from '@axia-js/types/interfaces/mmr';
import type { StorageKind } from '@axia-js/types/interfaces/offchain';
import type { FeeDetails, RuntimeDispatchInfo } from '@axia-js/types/interfaces/payment';
import type { RpcMethods } from '@axia-js/types/interfaces/rpc';
import type { AccountId, BlockNumber, H160, H256, H64, Hash, Header, Index, Justification, KeyValue, SignedBlock, StorageData } from '@axia-js/types/interfaces/runtime';
import type { ReadProof, RuntimeVersion, TraceBlockResponse } from '@axia-js/types/interfaces/state';
import type { ApplyExtrinsicResult, ChainProperties, ChainType, Health, NetworkState, NodeRole, PeerInfo, SyncState } from '@axia-js/types/interfaces/system';
import type { AnyNumber, Codec, IExtrinsic, Observable } from '@axia-js/types/types';

declare module '@axia-js/rpc-core/types.jsonrpc' {
