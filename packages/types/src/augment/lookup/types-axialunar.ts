...
import type { BitVec, Bytes, Compact, Enum, Null, Option, Result, Struct, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from '@axia-js/types';
import type { AccountId32, H256, PerU16 } from '@axia-js/types/interfaces/runtime';
import type { ITuple } from '@axia-js/types/types';

declare module '@axia-js/types/lookup' {

  /** @name AxiaTestRuntimeProxyType (75) */
  export interface AxiaTestRuntimeProxyType extends Enum {
  ...
  /** @name AxiaaxcPrimitivesV1CandidateReceipt (86) */
  export interface AxiaaxcPrimitivesV1CandidateReceipt extends Struct {
    readonly descriptor: AxiaaxcPrimitivesV1CandidateDescriptor;
    readonly commitmentsHash: H256;
  }

  /** @name AxiaaxcPrimitivesV1CandidateDescriptor (87) */
  export interface AxiaaxcPrimitivesV1CandidateDescriptor extends Struct {
    readonly paraId: u32;
    readonly relayParent: H256;
    readonly collator: AxiaaxcPrimitivesV0CollatorAppPublic;
    readonly persistedValidationDataHash: H256;
    readonly povHash: H256;
    readonly erasureRoot: H256;
    readonly signature: AxiaaxcPrimitivesV0CollatorAppSignature;
    readonly paraHead: H256;
    readonly validationCodeHash: H256;
  }

  /** @name AxiaaxcPrimitivesV0CollatorAppPublic (89) */
  export interface AxiaaxcPrimitivesV0CollatorAppPublic extends SpCoreSr25519Public {}

  /** @name AxiaaxcPrimitivesV0CollatorAppSignature (90) */
  export interface AxiaaxcPrimitivesV0CollatorAppSignature extends SpCoreSr25519Signature {}
  ...
  /** @name AxiaaxcAllychainPrimitivesHrmpChannelId (102) */
  export interface AxiaaxcAllychainPrimitivesHrmpChannelId extends Struct {
    readonly sender: u32;
  ...
  /** @name AxiaTestRuntimeSessionKeys (237) */
  export interface AxiaTestRuntimeSessionKeys extends Struct {
  ...
  /** @name AxiaTestRuntimeNposCompactSolution24 (360) */
  export interface AxiaTestRuntimeNposCompactSolution24 extends Struct {
  ...
  /** @name AxiaaxcPrimitivesV1InherentData (448) */
  export interface AxiaaxcPrimitivesV1InherentData extends Struct {
    readonly bitfields: Vec<AxiaaxcPrimitivesV1SignedUncheckedSigned>;
    readonly backedCandidates: Vec<AxiaaxcPrimitivesV1BackedCandidate>;
    readonly disputes: Vec<AxiaaxcPrimitivesV1DisputeStatementSet>;
    readonly parentHeader: SpRuntimeGenericHeader;
  }

  /** @name AxiaaxcPrimitivesV1SignedUncheckedSigned (450) */
  export interface AxiaaxcPrimitivesV1SignedUncheckedSigned extends Struct {
    readonly payload: BitVec;
    readonly validatorIndex: u32;
    readonly signature: AxiaaxcPrimitivesV0ValidatorAppSignature;
  }

  /** @name BitvecOrderLsb0 (453) */
  export type BitvecOrderLsb0 = Null;

  /** @name AxiaaxcPrimitivesV0ValidatorAppSignature (455) */
  export interface AxiaaxcPrimitivesV0ValidatorAppSignature extends SpCoreSr25519Signature {}

  /** @name AxiaaxcPrimitivesV1BackedCandidate (457) */
  export interface AxiaaxcPrimitivesV1BackedCandidate extends Struct {
    readonly candidate: AxiaaxcPrimitivesV1CommittedCandidateReceipt;
    readonly validityVotes: Vec<AxiaaxcPrimitivesV0ValidityAttestation>;
    readonly validatorIndices: BitVec;
  }

  /** @name AxiaaxcPrimitivesV1CommittedCandidateReceipt (458) */
  export interface AxiaaxcPrimitivesV1CommittedCandidateReceipt extends Struct {
    readonly descriptor: AxiaaxcPrimitivesV1CandidateDescriptor;
    readonly commitments: AxiaaxcPrimitivesV1CandidateCommitments;
  }

  /** @name AxiaaxcPrimitivesV1CandidateCommitments (459) */
  export interface AxiaaxcPrimitivesV1CandidateCommitments extends Struct {
    readonly upwardMessages: Vec<Bytes>;
    readonly horizontalMessages: Vec<AxiaaxcCorePrimitivesOutboundHrmpMessage>;
  ...
  /** @name AxiaaxcCorePrimitivesOutboundHrmpMessage (461) */
  export interface AxiaaxcCorePrimitivesOutboundHrmpMessage extends Struct {
    readonly recipient: u32;
    readonly data: Bytes;
  }

  /** @name AxiaaxcPrimitivesV0ValidityAttestation (465) */
  export interface AxiaaxcPrimitivesV0ValidityAttestation extends Enum {
    readonly isUnused0: boolean;
    readonly isImplicit: boolean;
    readonly asImplicit: AxiaaxcPrimitivesV0ValidatorAppSignature;
    readonly isExplicit: boolean;
    readonly asExplicit: AxiaaxcPrimitivesV0ValidatorAppSignature;
  }

  /** @name AxiaaxcPrimitivesV1DisputeStatementSet (467) */
  export interface AxiaaxcPrimitivesV1DisputeStatementSet extends Struct {
    readonly candidateHash: H256;
    readonly session: u32;
    readonly statements: Vec<ITuple<[AxiaaxcPrimitivesV1DisputeStatement, u32, AxiaaxcPrimitivesV0ValidatorAppSignature]>>;
  }

  /** @name AxiaaxcPrimitivesV1DisputeStatement (471) */
  export interface AxiaaxcPrimitivesV1DisputeStatement extends Enum {
    readonly isValid: boolean;
    readonly asValid: AxiaaxcPrimitivesV1ValidDisputeStatementKind;
    readonly isInvalid: boolean;
    readonly asInvalid: AxiaaxcPrimitivesV1InvalidDisputeStatementKind;
  }

  /** @name AxiaaxcPrimitivesV1ValidDisputeStatementKind (472) */
  export interface AxiaaxcPrimitivesV1ValidDisputeStatementKind extends Enum {
    readonly isExplicit: boolean;
  ...
  /** @name AxiaaxcPrimitivesV1InvalidDisputeStatementKind (473) */
  export interface AxiaaxcPrimitivesV1InvalidDisputeStatementKind extends Enum {
    readonly isExplicit: boolean;
  }
  ...
  /** @name AxiaTestRuntimeOriginCaller (563) */
  export interface AxiaTestRuntimeOriginCaller extends Enum {
    ...
    readonly isAllychainsOrigin: boolean;
    readonly asAllychainsOrigin: AxiaaxcRuntimeAllychainsOriginPalletOrigin;
  ...
  /** @name AxiaaxcRuntimeAllychainsOriginPalletOrigin (567) */
  export interface AxiaaxcRuntimeAllychainsOriginPalletOrigin extends Enum {
    readonly isAllychain: boolean;
    readonly asAllychain: u32;
  }
  ...
  /** @name AxiaaxcRuntimeAllychainsConfigurationHostConfiguration (607) */
  export interface AxiaaxcRuntimeAllychainsConfigurationHostConfiguration extends Struct {
    ...
    readonly hrmpMaxAllychainOutboundChannels: u32;
    ...
    readonly hrmpMaxAllychainInboundChannels: u32;
  ...
  /** @name AxiaaxcRuntimeAllychainsInclusionAvailabilityBitfieldRecord (611) */
  export interface AxiaaxcRuntimeAllychainsInclusionAvailabilityBitfieldRecord extends Struct {
    readonly bitfield: BitVec;
    readonly submittedAt: u32;
  }

  /** @name AxiaaxcRuntimeAllychainsInclusionCandidatePendingAvailability (612) */
  export interface AxiaaxcRuntimeAllychainsInclusionCandidatePendingAvailability extends Struct {
    readonly core: u32;
    readonly hash_: H256;
    readonly descriptor: AxiaaxcPrimitivesV1CandidateDescriptor;
  ...
  /** @name AxiaaxcRuntimeAllychainsSchedulerParathreadClaimQueue (616) */
  export interface AxiaaxcRuntimeAllychainsSchedulerParathreadClaimQueue extends Struct {
    readonly queue: Vec<AxiaaxcRuntimeAllychainsSchedulerQueuedParathread>;
    readonly nextCoreOffset: u32;
  }

  /** @name AxiaaxcRuntimeAllychainsSchedulerQueuedParathread (618) */
  export interface AxiaaxcRuntimeAllychainsSchedulerQueuedParathread extends Struct {
    readonly claim: AxiaaxcPrimitivesV1ParathreadEntry;
    readonly coreOffset: u32;
  }

  /** @name AxiaaxcPrimitivesV1ParathreadEntry (619) */
  export interface AxiaaxcPrimitivesV1ParathreadEntry extends Struct {
    readonly claim: AxiaaxcPrimitivesV1ParathreadClaim;
    readonly retries: u32;
  }

  /** @name AxiaaxcPrimitivesV1ParathreadClaim (620) */
  export interface AxiaaxcPrimitivesV1ParathreadClaim extends ITuple<[u32, AxiaaxcPrimitivesV0CollatorAppPublic]> {}

  /** @name AxiaaxcPrimitivesV1CoreOccupied (623) */
  export interface AxiaaxcPrimitivesV1CoreOccupied extends Enum {
    readonly isParathread: boolean;
    readonly asParathread: AxiaaxcPrimitivesV1ParathreadEntry;
    readonly isAllychain: boolean;
  }

  /** @name AxiaaxcRuntimeAllychainsSchedulerCoreAssignment (626) */
  export interface AxiaaxcRuntimeAllychainsSchedulerCoreAssignment extends Struct {
    readonly core: u32;
    readonly paraId: u32;
    readonly kind: AxiaaxcRuntimeAllychainsSchedulerAssignmentKind;
    readonly groupIdx: u32;
  }

  /** @name AxiaaxcRuntimeAllychainsSchedulerAssignmentKind (627) */
  export interface AxiaaxcRuntimeAllychainsSchedulerAssignmentKind extends Enum {
    readonly isAllychain: boolean;
    readonly isParathread: boolean;
    readonly asParathread: ITuple<[AxiaaxcPrimitivesV0CollatorAppPublic, u32]>;
  }

  /** @name AxiaaxcRuntimeAllychainsParasParaLifecycle (628) */
  export interface AxiaaxcRuntimeAllychainsParasParaLifecycle extends Enum {
    readonly isOnboarding: boolean;
    readonly isParathread: boolean;
    readonly isAllychain: boolean;
    readonly isUpgradingParathread: boolean;
    readonly isDowngradingAllychain: boolean;
    readonly isOffboardingParathread: boolean;
    readonly isOffboardingAllychain: boolean;
  }

  /** @name AxiaaxcRuntimeAllychainsParasParaPastCodeMeta (630) */
  export interface AxiaaxcRuntimeAllychainsParasParaPastCodeMeta extends Struct {
    readonly upgradeTimes: Vec<AxiaaxcRuntimeAllychainsParasReplacementTimes>;
    readonly lastPruned: Option<u32>;
  }

  /** @name AxiaaxcRuntimeAllychainsParasReplacementTimes (632) */
  export interface AxiaaxcRuntimeAllychainsParasReplacementTimes extends Struct {
    readonly expectedAt: u32;
    readonly activatedAt: u32;
  }

  /** @name AxiaaxcPrimitivesV1UpgradeGoAhead (634) */
  export interface AxiaaxcPrimitivesV1UpgradeGoAhead extends Enum {
    readonly isAbort: boolean;
    readonly isGoAhead: boolean;
  }

  /** @name AxiaaxcPrimitivesV1UpgradeRestriction (635) */
  export interface AxiaaxcPrimitivesV1UpgradeRestriction extends Enum {
    readonly isPresent: boolean;
  }

  /** @name AxiaaxcRuntimeAllychainsParasParaGenesisArgs (636) */
  export interface AxiaaxcRuntimeAllychainsParasParaGenesisArgs extends Struct {
    readonly genesisHead: Bytes;
    readonly validationCode: Bytes;
    readonly allychain: bool;
  }

  /** @name AxiaaxcRuntimeAllychainsInitializerBufferedSessionChange (639) */
  export interface AxiaaxcRuntimeAllychainsInitializerBufferedSessionChange extends Struct {
    readonly validators: Vec<AxiaaxcPrimitivesV0ValidatorAppPublic>;
    readonly queued: Vec<AxiaaxcPrimitivesV0ValidatorAppPublic>;
    readonly sessionIndex: u32;
  }

  /** @name AxiaaxcCorePrimitivesInboundDownwardMessage (641) */
  export interface AxiaaxcCorePrimitivesInboundDownwardMessage extends Struct {
    readonly sentAt: u32;
    readonly msg: Bytes;
  }

  /** @name AxiaaxcRuntimeAllychainsHrmpHrmpOpenChannelRequest (644) */
  export interface AxiaaxcRuntimeAllychainsHrmpHrmpOpenChannelRequest extends Struct {
  ...
  /** @name AxiaaxcRuntimeAllychainsHrmpHrmpChannel (646) */
  export interface AxiaaxcRuntimeAllychainsHrmpHrmpChannel extends Struct {
    readonly maxCapacity: u32;
    readonly maxTotalSize: u32;
    readonly maxMessageSize: u32;
  ...
  /** @name AxiaaxcCorePrimitivesInboundHrmpMessage (649) */
  export interface AxiaaxcCorePrimitivesInboundHrmpMessage extends Struct {
    readonly sentAt: u32;
    readonly data: Bytes;
  }

  /** @name AxiaaxcPrimitivesV1SessionInfo (654) */
  export interface AxiaaxcPrimitivesV1SessionInfo extends Struct {
    readonly validators: Vec<AxiaaxcPrimitivesV0ValidatorAppPublic>;
    readonly discoveryKeys: Vec<SpAuthorityDiscoveryAppPublic>;
    readonly assignmentKeys: Vec<AxiaaxcPrimitivesV1AssignmentAppPublic>;
  ...
  /** @name AxiaaxcRuntimeCommonParasRegistrarParaInfo (656) */
  export interface AxiaaxcRuntimeCommonParasRegistrarParaInfo extends Struct {
    readonly manager: AccountId32;
    readonly deposit: u128;
    readonly locked: bool;
  }

  /** @name AxiaaxcRuntimeCommonCrowdloanFundInfo (666) */
  export interface AxiaaxcRuntimeCommonCrowdloanFundInfo extends Struct {
    ...
    readonly end: u32;
    readonly cap: u128;
    readonly lastContribution: AxiaaxcRuntimeCommonCrowdloanLastContribution;
    readonly firstPeriod: u32;
    readonly lastPeriod: u32;
    readonly trieIndex: u32;
  }

  /** @name AxiaaxcRuntimeCommonCrowdloanLastContribution (667) */
  export interface AxiaaxcRuntimeCommonCrowdloanLastContribution extends Enum {
  ...
  /** @name AxiaTestRuntimeRuntime (690) */
  export type AxiaTestRuntimeRuntime = Null;
