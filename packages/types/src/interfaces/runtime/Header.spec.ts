...
import json1 from '@axia-js/types-support/json/Header.001.json';
import json2 from '@axia-js/types-support/json/Header.002.json';
import json3 from '@axia-js/types-support/json/Header.003.json';
import block00300 from '@axia-js/types-support/json/SignedBlock.003.00.json';
import block00301 from '@axia-js/types-support/json/SignedBlock.003.01.json';
