...
import type { Bytes, Struct, U8aFixed, Vec, u32 } from '@axia-js/types';
import type { AccountId, ValidatorId } from '@axia-js/types/interfaces/runtime';
import type { Exposure } from '@axia-js/types/interfaces/staking';
