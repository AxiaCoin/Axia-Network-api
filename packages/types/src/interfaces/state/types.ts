...
import type { Bytes, Enum, HashMap, Option, StorageKey, Struct, Text, U8aFixed, Vec, bool, u32, u64 } from '@axia-js/types';
import type { Hash, StorageData } from '@axia-js/types/interfaces/runtime';
