...
import type { Bytes, Struct, U8aFixed, Vec } from '@axia-js/types';
import type { AccountId, Hash, Perbill } from '@axia-js/types/interfaces/runtime';
import type { IdentificationTuple, SessionIndex } from '@axia-js/types/interfaces/session';
