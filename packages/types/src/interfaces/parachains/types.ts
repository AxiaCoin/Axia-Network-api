...
import type { BTreeMap, BitVec, Bytes, Enum, Option, Struct, U8aFixed, Vec, bool, u32 } from '@axia-js/types';
import type { Signature } from '@axia-js/types/interfaces/extrinsics';
import type { AccountId, Balance, BalanceOf, BlockNumber, H256, Hash, Header, StorageProof, ValidatorId, Weight } from '@axia-js/types/interfaces/runtime';
import type { MembershipProof, SessionIndex } from '@axia-js/types/interfaces/session';
...
export interface AbridgedCandidateReceipt extends Struct {
  readonly allychainIndex: ParaId;
...
/** @name IncomingAllychain */
export interface IncomingAllychain extends Enum {
  readonly isUnset: boolean;
  readonly asUnset: NewBidder;
  readonly isFixed: boolean;
  readonly asFixed: IncomingAllychainFixed;
  readonly isDeploy: boolean;
  readonly asDeploy: IncomingAllychainDeploy;
}

/** @name IncomingAllychainDeploy */
export interface IncomingAllychainDeploy extends Struct {
  readonly code: ValidationCode;
  readonly initialHeadData: HeadData;
}

/** @name IncomingAllychainFixed */
export interface IncomingAllychainFixed extends Struct {
...
/** @name AllychainDispatchOrigin */
export interface AllychainDispatchOrigin extends Enum {
  readonly isSigned: boolean;
  readonly isAllychain: boolean;
  readonly isRoot: boolean;
}

/** @name AllychainInherentData */
export interface AllychainInherentData extends Struct {
...
/** @name AllychainProposal */
export interface AllychainProposal extends Struct {
...
/** @name AllychainsInherentData */
export interface AllychainsInherentData extends Struct {
...
/** @name RegisteredAllychainInfo */
export interface RegisteredAllychainInfo extends Struct {
  readonly validators: Vec<ValidatorId>;
  readonly proposer: AccountId;
}
...
export interface SystemInherentData extends AllychainInherentData {}
...
export type PHANTOM_ALLYCHAINS = 'allychains';
