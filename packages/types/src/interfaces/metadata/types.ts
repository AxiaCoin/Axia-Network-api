...
import type { Bytes, Enum, GenericPortableRegistry, Option, Struct, Text, Type, Vec, bool, u8 } from '@axia-js/types';
import type { SiField, SiLookupTypeId, SiType } from '@axia-js/types/interfaces/scaleInfo';
