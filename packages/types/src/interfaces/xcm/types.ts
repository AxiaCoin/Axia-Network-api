...
import type { Bytes, Compact, Enum, Null, Option, Result, Struct, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from '@axia-js/types';
import type { AccountId, BlockNumber, Weight } from '@axia-js/types/interfaces/runtime';
