...
import type { Bytes, Compact, Enum, Null, Option, Raw, Struct, Text, U8aFixed, bool, u32, u64, u8 } from '@axia-js/types';
import type { AccountId, Balance, BlockNumber, Hash, Weight } from '@axia-js/types/interfaces/runtime';
