...
import type { BTreeMap, Bytes, Enum, Option, Raw, Struct, Text, U8aFixed, Vec, bool, u32, u64 } from '@axia-js/types';
import type { Si0LookupTypeId, Si0Path, Si0Type } from '@axia-js/types/interfaces/scaleInfo';
