...
import type { Bytes, Enum, Option, Struct, Vec, bool, u32 } from '@axia-js/types';
import type { Vote, VoteThreshold } from '@axia-js/types/interfaces/elections';
import type { AccountId, Balance, BlockNumber, Call, Hash } from '@axia-js/types/interfaces/runtime';
