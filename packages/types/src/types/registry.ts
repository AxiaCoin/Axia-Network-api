...
export interface RegisteredTypes {
   ...
   * uses types not available in the base Axlib runtime.
   */
  types?: RegistryTypes;
  /**
  ...
  /**
   * @description Additional types that are injected based on the chain we are connecting to. There are keyed by the chain, i.e. `{ 'AXIALunar CC1': { ... } }`
   */
