...
/** @internal */
function createRuntimeFunction (method: string, key: string, { docs, type }: AxlibMetadata): (registry: Registry) => StorageEntry {
...
export const axlib: Record<string, Creator> = {
