const axiaTypes = (function (exports, util, utilCrypto) {
  ...
  const keyTypes = {
    // key for beefy
    BeefyKey: '[u8; 33]',
    // default to Axlib master defaults, 4 keys (axia master, 5 keys)
    Keys: 'SessionKeys4',
  ...
  const definitions$q = {
    rpc: {
      ...
      resetLogFilter: {
        description: 'Resets the log filter to Axlib defaults',
        params: [],
        type: 'Null'
      }
    },
  ...
  const oldTypes = {
    ...
    IncomingAllychain: {
      _enum: {
        Unset: 'NewBidder',
        Fixed: 'IncomingAllychainFixed',
        Deploy: 'IncomingAllychainDeploy'
      }
    },
  ...
  */
  ...
  const allExtensions = _objectSpread$g(_objectSpread$g(_objectSpread$g(_objectSpread$g({}, axlib$1), axia), shell), statemint); // the v4 signed extensions prior to the point of exposing these to the metadata.
   ...
   * specific to a specific Axlib runtime
   */
  ...
  // see https://github.com/axia-tech/axlib/pull/4462
