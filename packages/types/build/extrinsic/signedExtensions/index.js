...
import { axlib } from "./axlib.js"; // A mapping of the known signed extensions to the extra fields that they contain. Unlike in the actual extensions,
...
export const allExtensions = _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, axlib), axia), shell), statemint); // the v4 signed extensions prior to the point of exposing these to the metadata.
