...
export interface TypeImports {
  codecTypes: TypeExist; // `import {} from '@axia-js/types/codec`
  extrinsicTypes: TypeExist; // `import {} from '@axia-js/types/extrinsic`
  genericTypes: TypeExist; // `import {} from '@axia-js/types/generic`
  ignoredTypes: string[]; // No need to import these types
  localTypes: TypeExistMap; // `import {} from '../something'`
  primitiveTypes: TypeExist; // `import {} from '@axia-js/types/primitive`
  metadataTypes: TypeExist; // `import {} from '@axia-js/types/metadata`
  typesTypes: TypeExist; // `import {} from '@axia-js/types/types`
