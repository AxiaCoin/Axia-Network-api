...
import type { TypeRegistry } from '@axia-js/types/create';
import type { Definitions } from '@axia-js/types/types';
...
export function generateRpcTypes (registry: TypeRegistry, importDefinitions: Record<string, Definitions>, dest: string, extraTypes: ExtraTypes = {}): void {
  writeFile(dest, (): string => {
    const allTypes: ExtraTypes = { '@axia-js/types/interfaces': importDefinitions, ...extraTypes };
